...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a class="nav-link active" href="user_issue_tracker.php">Issue Tracker</a></li>
...
<div class="container mt-4">
    ...
    <form method="POST" action="issue_tracker.php">
        <button type="submit" name="export_issues" class="btn btn-success mb-3">Export Report as CSV</button>
    </form>
