        ...
        <div class="col-md-4">
            <div class="card text-center bg-primary text-white">
                <div class="card-body">
                    ...
                    <a href="manage_users.php" class="btn btn-outline-light">View Users</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card text-center bg-success text-white">
                <div class="card-body">
                    ...
                    <a href="compliance_tasks.php" class="btn btn-outline-light">View Tasks</a>
                </div>
            </div>
        </div>
        <!-- Documents Card -->
        <div class="col-md-4">
            <div class="card text-center bg-info text-white">
                <div class="card-body">
                    ...
                    <a href="manage_documents.php" class="btn btn-outline-light">View Documents</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    ?>
                    <a href="manage_notifications.php" class="btn btn-dark btn-sm">View All Notifications</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    ?>
                    <a href="compliance_tasks.php" class="btn btn-dark btn-sm">View All Tasks</a>
                </div>
            </div>
        </div>
    </div>
