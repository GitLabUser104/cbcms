...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a class="nav-link active" href="compliance_tasks.php">Compliance Tasks</a></li>
...
<div class="container mt-4">
    ...
    <!-- Add Task Button -->
    <button type="button" class="btn btn-primary my-3" data-toggle="modal" data-target="#taskModal" onclick="openAddTaskModal()">Add Task</button>
                ...
                <?php foreach ($tasks as $task): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-sm btn-danger" onclick="deleteTask(<?php echo $task['task_id']; ?>)">Delete</button>
                        </td>
